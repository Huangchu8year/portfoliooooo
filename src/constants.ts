  ...
  works: [
    {
      ...
      thumbnail: asset('v1-universe.png'),
...

    {
      ...
      thumbnail: asset('v4-coconut.png'),
...

    {
      ...
      thumbnail: asset('v3-catmeme.png'),
...

    {
      ...
      thumbnail: asset('v5-interview.png'),
...

    {
      ...
      thumbnail: asset('deepfake-handbook.jpg'),
      responsibilities: '排版、设计',
      responsibilitiesEn: "Layout",
      link: asset('deepfake-handbook.pdf')
    },

    {
      ...
      thumbnail: asset('ordinary-light-layout.jpg'),
      responsibilities: '设计、排版、拍摄、文案',
      responsibilitiesEn: "Design and layout",
      link: asset('ordinary-light-layout.pdf')
    },

    {
      ...
      thumbnail: asset('star-ticket-design.jpg'),
      responsibilities: '设计',
      responsibilitiesEn: "Design",
      link: asset('star-ticket-design.pdf')
    },

    {
      ...
      thumbnail: asset('aihuashi-poster.png'),
    ...
    },
    {
      ...
      thumbnail: asset('constitution-day.jpg'),
      responsibilities: '海报设计',
      responsibilitiesEn: 'Poster Design',
      link: '#'
    },
    {
      ...
      thumbnail: asset('mid-autumn.png'),
      responsibilities: '海报设计',
      responsibilitiesEn: 'Poster Design',
      link: '#'
    },
    {
      ...
      thumbnail: asset('moe-awakening.png'),
    ...
    },
    {
      ...
      thumbnail: asset('merch-circle.png'),
    ...
    },
    {
      ...
      thumbnail: asset('ordinary-heroes.png'),
